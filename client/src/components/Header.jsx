  ...
  return (
    <div className='flex flex-col items-center mt-16 px-6 text-center relative'>
      ...
      <div className='relative mt-4'>
        <img src={assets.main} alt='User avatar' className='w-40 h-40 rounded-full -xl border-4 border-gray-300' />
      ...
      <h2 className='text-xl sm:text-5xl font-bold text-gray-800 mt-2 tracking-tight'>Welcome to MedVision</h2>
      ...
      <p className='mt-4 text-gray-600 max-w-lg leading-relaxed text-lg'>
        ...
        Expert care today means a healthier tomorrow."      </p>
